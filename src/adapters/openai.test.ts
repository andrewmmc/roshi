...
describe('openaiAdapter', () => {
  describe('buildRequestBody', () => {
    ...
    it('uses image_url block for image attachments', () => {
      const request = makeRequest({
        messages: [
          makeMessage({
    ...
    it('uses image_url for URL-based image attachments', () => {
      const request = makeRequest({
        messages: [
          makeMessage({
    ...
    it('mixes image and file attachments correctly', () => {
      const request = makeRequest({
        messages: [
          makeMessage({
            content: 'Review both',
  ...
  describe('buildRequestUrl', () => {
    it('constructs URL from baseUrl and endpoint', () => {
      ...
      expect(openaiAdapter.buildRequestUrl(provider)).toBe(
