...
const openaiGenerators: CodeGenerator[] = [
  openaiPythonGenerator,
  openaiNodeGenerator,
];

const anthropicGenerators: CodeGenerator[] = [
  anthropicPythonGenerator,
  anthropicNodeGenerator,
];

const geminiGenerators: CodeGenerator[] = [
  geminiPythonGenerator,
  geminiNodeGenerator,
];
