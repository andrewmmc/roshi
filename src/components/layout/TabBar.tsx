              ...
              >
                ...
                {canClose && (
                  <button
                    ...
                    className={cn(
                      'text-muted-foreground hover:text-foreground focus-visible:ring-ring mr-0.5 flex size-7 shrink-0 cursor-pointer items-center justify-center rounded focus-visible:ring-1 focus-visible:outline-none',
                      isActive
