...
function DialogContent({
  ...
  return (
    <DialogPortal>
      <DialogOverlay
        className={showOverlay ? undefined : 'pointer-events-none'}
      />
...
function DialogFooter({
  ...
  return (
    <div
      ...
      className={cn(
        'bg-muted/30 -mx-4 -mb-4 flex flex-col-reverse gap-2 rounded-b-xl border-t p-4 sm:flex-row sm:justify-end',
        className,
      )}
      {...props}
    >
