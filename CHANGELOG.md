...
- The eval tab's runner and judge model pickers stay clickable when the selected provider has no models, opening the dropdown with a placeholder message instead of being disabled

## [2.0.2] - 2026-07-16

### Fixed

- The request model picker now refreshes and selects the first model when one is added to a provider with an empty model list

## [2.0.1] - 2026-07-14

### Changed

- Improved response rendering performance by throttling streaming chat updates, bounding raw JSON highlighting, and caching code views until their source changes

### Fixed

- Response panels now retain the content associated with each request snapshot
